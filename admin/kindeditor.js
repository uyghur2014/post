...
_extend(KEdit, KWidget, {
	init : function(options) {
		...
		self.iframe = K('<iframe id="shahdiyar" class="ke-edit-iframe" hidefocus="true" frameborder="0"' + iframeSrc + '></iframe>').css('width', '100%');
		...
		function ready() {
			...
			doc.close();
			doc.body.style.fontFamily="Alkatip Basma Tom";
			doc.body.style.fontSize="16px";
			doc.body.style.direction="rtl";
			nuiKeyFunc('shahdiyar',null);
...
_plugin('core', function(K) {
	...
	self.clickToolbar('about', function() {
		var html = '<div style="margin:20px; direction: right;"><center>' +
			'<div>شاھدىيار ئېلېكترون پەن - تېخنىكا تەرەققىيات چەكلىك شىركىتى</div>' +
			'<div>Shahdiyar Electronic Technology Development Co.,LTD</div>' +
			'<div dir="rtl">تور قۇرۇلۇشى، يۇمشاق دېتال قۇرۇلۇشى، ئەپ قۇرۇلۇشى...</div>' +
			'<div>NetWork, Software, App Development...</div>' +
			'<div>Shahdiyarsoft &reg; Website: <a target="_blank" href="http://www.shahdiyar.com">http://www.shahdiyar.com</a></div>' +
			'<div>Copyright © KindEditor</div>' +
			'</center></div>';
		self.createDialog({
			name : 'about',
			width : 350,
